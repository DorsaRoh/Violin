...
public class EasyViolinTiles extends World
{
    ...
    public void act(){
        ...
        else if(waitTimeLeft == 0 && score < 9){
            tiles.clearPoints();
            Greenfoot.setWorld(new noHardGame());
        }
        else if(waitTimeLeft == 0 && score > 9){
            tiles.clearPoints();
            Greenfoot.setWorld(new yesHardGame());
        }
    }
    
    
    // easy game - twinkle twinkle little star
    // keys to play: q q 1 1 2 2 1 r r e e w w q q 1 1 r r e e w 1 1 r r e e w q q 1 1 2 2 1 r r e e w w q 
    private void easyGame(){
        addObject(new Tile("Q", 3, 20, "A1"), 309, 55);
        addObject(new Tile("Q", 3, 80, "A1"), 309, 55);
        addObject(new Tile("1", 3, 130, "E1"), 309, 55);
        addObject(new Tile("1", 3, 180, "E1"), 309, 55);
        
        addObject(new Tile("2", 3, 230, "E2"), 458, 55);
        addObject(new Tile("2", 3, 280, "E2"), 458, 55);
        addObject(new Tile("1", 3, 330, "E1"), 309, 55);
        
        addObject(new Tile("R", 3, 380, "A4"), 714, 55);
        addObject(new Tile("R", 3, 430, "A4"), 714, 55);
        addObject(new Tile("E", 3, 480, "A3"), 594, 55);
        addObject(new Tile("E", 3, 530, "A3"), 594, 55);
        addObject(new Tile("W", 3, 580, "A2"), 458, 55);
        addObject(new Tile("W", 3, 630, "A2"), 458, 55);
        addObject(new Tile("Q", 3, 680, "A1"), 309, 55);
        
        addObject(new Tile("1", 3, 760, "E1"), 309, 55);
        addObject(new Tile("1", 3, 810, "E1"), 309, 55);
        addObject(new Tile("R", 3, 850, "A4"), 714, 55);
        addObject(new Tile("R", 3, 890, "A4"), 714, 55);
        addObject(new Tile("E", 3, 930, "A3"), 594, 55);
        addObject(new Tile("E", 3, 970, "A3"), 594, 55);
        addObject(new Tile("W", 3, 1010, "A2"), 458, 55);

        addObject(new Tile("1", 3, 1090, "E1"), 309, 55);
        addObject(new Tile("1", 3, 1140, "E1"), 309, 55);
        addObject(new Tile("R", 3, 1160, "A4"), 714, 55);
        addObject(new Tile("R", 3, 1210, "A4"), 714, 55);
        addObject(new Tile("E", 3, 1260, "A3"), 594, 55);
        addObject(new Tile("E", 3, 1310, "A3"), 594, 55);
        addObject(new Tile("W", 3, 1360, "A2"), 458, 55);
        
        
        addObject(new Tile("Q", 3, 1440, "A1"), 309, 55);
        addObject(new Tile("Q", 3, 1490, "A1"), 309, 55);
        addObject(new Tile("1", 3, 1540, "E1"), 309, 55);
        addObject(new Tile("1", 3, 1590, "E1"), 309, 55);
        
        addObject(new Tile("2", 3, 1640, "E2"), 458, 55);
        addObject(new Tile("2", 3, 1690, "E2"), 458, 55);
        addObject(new Tile("1", 3, 1740, "E1"), 309, 55);
        
        addObject(new Tile("R", 3, 1790, "A4"), 714, 55);
        addObject(new Tile("R", 3, 1840, "A4"), 714, 55);
        addObject(new Tile("E", 3, 1890, "A3"), 594, 55);
        addObject(new Tile("E", 3, 1940, "A3"), 594, 55);
        addObject(new Tile("W", 3, 1990, "A2"), 458, 55);
        addObject(new Tile("W", 3, 2040, "A2"), 458, 55);
        addObject(new Tile("Q", 3, 2090, "A1"), 309, 55);
